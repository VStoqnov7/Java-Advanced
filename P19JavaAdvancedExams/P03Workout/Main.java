...
// Print P13Exercise
        System.out.println(exercise); // P13Exercise: Bench Press, chest, 30
...
//Get mostBurnedCaloriesExercise
        ...
        System.out.println(mostBurnedCaloriesExercise); // P13Exercise: Squats, legs, 60

        Exercise exerciseByNameAndMuscle = workout.getExercise("Deadlift", "back");
        System.out.println(exerciseByNameAndMuscle); // P13Exercise: Deadlift, back, 50
...
//P13Exercise: Deadlift, back, 50
//P13Exercise: Squats, legs, 60
